        ...
        <>
          ...
          <div className="overflow-x-auto rounded-2xl border border-mist-deep bg-paper">
            <table className="w-full min-w-[680px] border-collapse text-sm">
              ...
              <tbody>
                {list.map((book) => (
                  <tr key={book.id} className="group border-b border-mist transition-colors last:border-0 hover:bg-cream">
                    <td className="px-4 py-3">
                      <Link href={`/books/${book.id}`} className="flex min-w-0 items-center gap-3">
